...
The program prints actions (with unique numbering) to `main.out`. Actions include skiers starting, arriving, boarding, skiing, and bus events like arriving/leaving/final.
...
- Author: Andrej Chalány, FIT VUT, 2024
